...
const Footer = () => {
  ...
  const socialLinks = [
    {
      icon: Facebook,
      href: "https://facebook.com/neoplatron",
      label: "Facebook",
    },
    {
      icon: Twitter,
      href: "https://twitter.com/neoplatron",
      label: "Twitter",
    },
    {
      icon: Instagram,
      href: "https://instagram.com/neoplatron",
      label: "Instagram",
    },
    {
      icon: Linkedin,
      href: "https://linkedin.com/company/neoplatron",
      label: "LinkedIn",
    },
    {
      icon: Youtube,
      href: "https://youtube.com/@neoplatron",
      label: "YouTube",
    },
  ];
                ...
                return (
                  <a
                    ...
                    className="w-10 h-10 rounded-full bg-bg dark:bg-d-bg 
                       ...
                       hover:bg-primary dark:hover:bg-d-primary 
                       hover:text-text-white dark:hover:text-text-white
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex justify-center items-center">
            ...
            <p className="text-sm text-text-para dark:text-d-text-para text-center">
              © {currentYear} Neoplatron. All rights reserved.
            </p>
          </div>
        </div>
      </div>
