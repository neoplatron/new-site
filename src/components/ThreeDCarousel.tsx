...
//     const radius = Math.round((280 / 2) / Math.tan(Math.PI / itemCount)); // 280px is card width

//     return (
//         <div className="scene-3d w-[280px] h-[320px] mx-auto perspective-1000 relative my-10">
...
//                         <div
//                             key={index}
//                             className="carousel-cell absolute left-0 top-0 w-[280px] h-[320px] bg-bg-light dark:bg-d-bg-light rounded-2xl shadow-lg border border-border dark:border-d-border p-6 flex flex-col items-center justify-center text-center backface-hidden opacity-95"
//                             style={{
