        ...
        <div className="grid lg:grid-cols-[30%_70%] gap-6 md:gap-8">
          ...
          <div className="space-y-4 md:space-y-6">
            ...
            <p className="text-xs text-text-muted dark:text-d-text-muted mt-6 md:mt-8 text-center italic opacity-70">
              * The above calculations represent the minimum expected mileage. Actual mileage may vary and can be higher depending on factors such as driving conditions, driving habits, road quality, vehicle maintenance, and load.
            </p>
            {/* Summary Card */}
            {/* {results && (
