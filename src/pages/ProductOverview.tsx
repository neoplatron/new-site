...
const ProductOverview: React.FC = () => {
  ...
  const products = [
    ...
    },
    {
      name: "Platron 3W",
      capacity: "150 - 350cc",
      vehicles: "All Petrol 3W Autos, All Diesel 3W Auto up to 350cc",
    },
    {
      name: "Platron 4W 1.8",
      capacity: "600 - 1800cc",
      vehicles: "Nano, Maruti 800, Alto to Corolla, Octavia",
    },
    {
      name: "Platron 4W 3.0",
      capacity: "1900 - 3000cc",
      vehicles:
        // "Skoda Laura, Toyota Innova, Scorpio, XUV500 to Mercedes Benz, Audi, BMW, Jaguar, Volvo",
        "All 4-wheelers upto 3000cc",
    },
    {
      name: "Platron 6W 4.5",
      capacity: "3100 - 4500cc",
      vehicles: "Mini Trucks & Mini Buses etc.",
    },
    {
      name: "Platron 6W 6.0",
      capacity: "5750 - 7000cc",
      vehicles: "Regular Buses & Regular Trucks etc.",
    },
    {
      name: "Platron 9W",
      capacity: "7000 - 9000cc",
      vehicles: "All vehicles upto 9000cc",
    },
    {
      name: "Platron 12W",
      capacity: "9000 - 12000cc",
      vehicles: "All vehicles upto 12000cc",
    },
  ];
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-8 sm:mb-12 lg:mb-16">
            ...
            <p className="text-base sm:text-lg text-text-para dark:text-d-text-para px-2">
              Platron can be fitted to ALL PETROL / DIESEL IC engines
            </p>
          </div>
      ...
      <section className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8 bg-primary text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-base sm:text-lg lg:text-xl text-bg-light/90 mb-6 sm:mb-8 lg:mb-10">
            Join 22,000+ satisfied customers and experience the power of ADPT
            technology
          </p>
