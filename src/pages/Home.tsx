...
import { ArrowRight, Award, Factory, TrendingUp, Trophy } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
            {achievements.map((item, index) => (
              <div
                key={index}
                className="group relative bg-bg-light dark:bg-d-bg-light rounded-2xl shadow-lg border border-border dark:border-d-border p-6 sm:p-8 hover:shadow-xl hover:border-primary/50 dark:hover:border-d-primary/50 transition-all duration-300"
              >
                <div className="flex flex-col items-center text-center h-full">
                  <div className="w-14 h-14 sm:w-16 sm:h-16 bg-primary/10 rounded-full flex items-center justify-center mb-4 sm:mb-6 text-primary group-hover:scale-110 group-hover:bg-primary group-hover:text-white transition-all duration-300">
                    {item.icon}
                  </div>
