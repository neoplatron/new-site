...
const AboutUs = () => {
  const milestones = [
    ...
    { year: "2025", event: "22,000+ installations completed across India" },
  ];
              ...
              <div className="relative">
                ...
                <div className="pl-6 sm:pl-8 space-y-5 sm:space-y-6">
                  ...
                  <div className="group">
                    ...
                    <p className="text-sm sm:text-base leading-relaxed text-text-para dark:text-d-text-para">
                      Under the leadership of Mr. V.A. Kishore Kumar, our
      ...
      {/* <section className="py-12 sm:py-24 px-4 sm:px-6 lg:px-8 bg-bg-light dark:bg-d-bg-light relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="text-center mb-8 sm:mb-16">
            ...
            <h2 className="font-title text-2xl sm:text-4xl lg:text-5xl font-bold text-text dark:text-d-text mb-3 sm:mb-4">
              <span className="text-transparent bg-clip-text bg-linear-to-r from-primary to-secondary">
                Leadership
              </span>
            </h2>
            <p className="text-base sm:text-lg text-text-para dark:text-d-text-para max-w-2xl mx-auto px-2">
              Pioneering innovation with decades of expertise
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="group relative">
              ...
              <div className="absolute inset-0 bg-linear-to-br from-primary/30 to-secondary/30 dark:from-d-primary/30 dark:to-d-secondary/30 rounded-2xl sm:rounded-3xl blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>

              <div className="relative bg-bg dark:bg-d-bg rounded-2xl sm:rounded-3xl p-6 sm:p-10 lg:p-12 border-2 border-border dark:border-d-border shadow-2xl hover:shadow-3xl transition-all duration-300">
                <div className="flex flex-col lg:flex-row items-start lg:items-center gap-5 sm:gap-8 mb-6 sm:mb-8">
                  
                  <div className="relative shrink-0 mx-auto lg:mx-0">
                   
                    <div className="absolute inset-0 w-24 h-24 sm:w-32 sm:h-32 bg-primary/20 rounded-full blur-xl animate-pulse"></div>
                    <div className="absolute inset-0 w-24 h-24 sm:w-32 sm:h-32 bg-secondary/20 rounded-full blur-2xl"></div>

                 
                    <div className="relative w-24 h-24 sm:w-32 sm:h-32 bg-linear-to-br from-primary via-secondary to-tertiary rounded-full flex items-center justify-center shadow-2xl ring-4 ring-bg dark:ring-d-bg group-hover:scale-105 transition-transform duration-300">
                      <Users className="w-12 h-12 sm:w-16 sm:h-16 text-white" />
                    </div>

                   
                    <div className="absolute -bottom-1 -right-1 sm:-bottom-2 sm:-right-2 bg-linear-to-r from-tertiary to-warning text-white px-3 py-1 sm:px-4 sm:py-2 rounded-lg sm:rounded-xl font-bold text-xs sm:text-sm shadow-lg border-2 border-bg dark:border-d-bg">
                      22+ Years
                    </div>
                  </div>
                  ...
                  <div className="flex-1 text-center lg:text-left">
                    <h3 className="font-title text-xl sm:text-3xl lg:text-4xl font-bold text-text dark:text-d-text mb-2 sm:mb-3">
                      Mr. V.A. Kishore Kumar
                    </h3>
                    <div className="flex flex-wrap items-center justify-center lg:justify-start gap-3 mb-3 sm:mb-4">
                      <span className="inline-flex items-center gap-2 bg-linear-to-r from-primary/10 to-secondary/10 dark:from-d-primary/10 dark:to-d-secondary/10 text-primary dark:text-d-primary px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg text-xs sm:text-sm font-semibold border border-primary/20 dark:border-d-primary/20">
                        <Briefcase className="w-3 h-3 sm:w-4 sm:h-4" />
                        Managing Director & Founder
                      </span>
                    </div>
                    <div className="h-0.5 sm:h-1 w-24 sm:w-32 bg-linear-to-r from-primary to-secondary rounded-full mx-auto lg:mx-0"></div>
                  </div>
                </div>

                
                <div className="space-y-4 sm:space-y-6">
                  <p className="text-sm sm:text-lg text-text-para dark:text-d-text-para leading-relaxed">
                    With over{" "}
                    <span className="font-bold text-primary dark:text-d-primary">
                      22 years of experience
                    </span>{" "}
                    in automobiles and alternative fuels, Mr. V.A. Kishore Kumar
                    has pioneered the development of NEOPLATRON's revolutionary
                    plasma technology. His vision and expertise have been
                    instrumental in creating a unique product that addresses
                    both environmental concerns and vehicle performance, making
                    sustainable mobility accessible to all.
                  </p>
                </div>

                
                <div className="mt-6 sm:mt-10 pt-5 sm:pt-8 border-t border-border dark:border-d-border">
                  <h4 className="font-title text-base sm:text-xl font-bold text-text dark:text-d-text mb-4 sm:mb-6">
                    Areas of Expertise
                  </h4>
                  <div className="grid sm:grid-cols-3 gap-3 sm:gap-4">
                    <div className="flex items-start gap-2 sm:gap-3 p-3 sm:p-4 rounded-lg sm:rounded-xl bg-bg-light dark:bg-d-bg-light border border-border-muted dark:border-d-border-muted">
                      <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg bg-primary/10 flex items-center justify-center shrink-0">
                        <Zap className="w-4 h-4 sm:w-5 sm:h-5 text-primary dark:text-d-primary" />
                      </div>
                      <div>
                        <div className="font-semibold text-text dark:text-d-text text-xs sm:text-sm mb-0.5 sm:mb-1">
                          Alternative Fuels
                        </div>
                        <div className="text-[10px] sm:text-xs text-text-para dark:text-d-text-para">
                    ...
                    <div className="flex items-start gap-2 sm:gap-3 p-3 sm:p-4 rounded-lg sm:rounded-xl bg-bg-light dark:bg-d-bg-light border border-border-muted dark:border-d-border-muted">
                      <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg bg-secondary/10 flex items-center justify-center shrink-0">
                        <Car className="w-4 h-4 sm:w-5 sm:h-5 text-secondary dark:text-d-secondary" />
                      </div>
                      <div>
                        <div className="font-semibold text-text dark:text-d-text text-xs sm:text-sm mb-0.5 sm:mb-1">
                          Automotive Tech
                    ...
                    <div className="flex items-start gap-2 sm:gap-3 p-3 sm:p-4 rounded-lg sm:rounded-xl bg-bg-light dark:bg-d-bg-light border border-border-muted dark:border-d-border-muted">
                      <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg bg-tertiary/10 flex items-center justify-center shrink-0">
                        <Leaf className="w-4 h-4 sm:w-5 sm:h-5 text-tertiary dark:text-d-tertiary" />
                      </div>
                      <div>
                        <div className="font-semibold text-text dark:text-d-text text-xs sm:text-sm mb-0.5 sm:mb-1">
                          Sustainability
                ...
                <div className="mt-5 sm:mt-8 relative">
                  <blockquote className="pl-3 sm:pl-4 pr-4 sm:pr-6 py-3 sm:py-4 italic text-sm sm:text-lg text-text-muted dark:text-d-text-muted border-l-4 border-primary dark:border-d-primary">
                    Making sustainable mobility accessible to all through
                    innovation and dedication to environmental excellence.
                  </blockquote>
                </div>
              </div>
            </div>
