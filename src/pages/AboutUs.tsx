...
const AboutUs = () => {
  const milestones = [
    ...
    { year: "2026", event: "26,000+ installations, expanding our partner network across India" },
  ];
          ...
          <div className="space-y-20">
            ...
            <div>
              ...
              <div className="grid lg:grid-cols-2 gap-8">
                ...
                <div className="bg-bg-light dark:bg-d-bg-light p-8 rounded-2xl border border-border dark:border-d-border flex flex-col md:flex-row gap-6 items-start hover:border-primary/30 transition-colors">
                  <div className="shrink-0 w-24 h-24 rounded-xl overflow-hidden shadow-md border border-border dark:border-d-border">
                    <img
                      src="/assets/advisors/rajendra_sharma.png"
                      alt="Dr. Rajendra Kumar Sharma"
                  ...
                  <div>
                    ...
                    <div className="text-secondary font-medium text-sm mb-3">
                      MSc-Physics, MMS-Finance, Ph.D., FMASc <br />
                      Technical Advisor
                    </div>
                    <div className="text-text-para dark:text-d-text-para text-sm space-y-3">
                      <p className="leading-relaxed">
                        With over 35 years of experience in Energy Storage, Dr. Sharma is the owner of India’s first Supercapacitor manufacturing facility and is widely recognized as the <strong>"Father of Supercapacitors"</strong> in the energy domain.
                      </p>

                      <div className="space-y-1">
                        <strong className="text-text dark:text-d-text block text-xs uppercase tracking-wide opacity-80">Key Positions:</strong>
                        <ul className="list-disc pl-4 space-y-1 opacity-90 text-xs">
                          <li>Director, Spel Technologies Pvt. Ltd., Pune.</li>
                          <li>Member, Technology Advisory Group (TAG) for eMobility (Ministry of Science & Tech).</li>
                          <li>Member, WG @ Ministry of Electronics & IT.</li>
                          <li>Scientific Advisory Board, Neutrino Energy Group Gmbh, Germany.</li>
                        </ul>
                      </div>

                      <div className="space-y-1">
                        <strong className="text-text dark:text-d-text block text-xs uppercase tracking-wide opacity-80">Key Achievements:</strong>
                        <ul className="list-disc pl-4 space-y-1 opacity-90 text-xs">
                          <li>Developed India’s first Supercapacitor facility & Li-Ion Capacitor.</li>
                          <li>7 US Patents, 1 PCT Patent.</li>
                          <li>Recipient of <strong>Vijayashree Award</strong>, <strong>Rashtriya Udyog Ratna</strong>, and <strong>World Leadership Award (UK)</strong>.</li>
                        </ul>
                      </div>
                    </div>
                  </div>
                ...
                {/* Dr. Janardhan Gude */}
                <div className="bg-bg-light dark:bg-d-bg-light p-8 rounded-2xl border border-border dark:border-d-border flex flex-col md:flex-row gap-6 items-start hover:border-secondary/30 transition-colors">
                  <div className="shrink-0 w-24 h-24 rounded-xl bg-white dark:bg-d-bg shadow-sm flex items-center justify-center text-3xl font-bold text-text-muted">
                    JG
                  </div>
                  <div>
